...
const Footer = () => {
    return (
        ...
        <footer class="bg-light text-center text-lg-start footer bottom_border fulid mt-5">

            <div class="text-center p-3" style={{ backgroundColor: "green" }}>
                © 2020 Copyright:
                <a class="text-dark" href="https://jewelacademey.com/">JEWEL ACADEMEY.com</a>
            </div>
        ...
        //     <p><small>copay right @ 2022 </small></p>
        // </footer>
    );
};
